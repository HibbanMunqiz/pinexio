...
<div>
- **`title`**: Defines the title displayed on the page.<br/>
- **`description`**: Helps with SEO and improves discoverability.
</div>

<Note>Use hyphens (`-`) in file names instead of spaces or special characters. The breadcrumb navigation will automatically format hyphens as spaces.</Note>
