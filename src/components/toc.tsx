              ...
              <li key={index} className="group">
                <Link
                  ...
                  className={`transition-colors flex items-center ${
                    isActive ? "text-primary font-bold" : "text-gray-700 dark:text-gray-200 font-normal"
                  }`}
                >
                  {item.title}
                </Link>
                        ...
                        <li key={subIndex} className="text-sm">
                          <Link
                            ...
                            className={`transition-colors block py-1 ${
                              isSubActive ? "text-primary font-bold" : "text-gray-600 dark:text-gray-200 font-regular"
                            }`}
                          >
                            {subItem.title}
                          </Link>
